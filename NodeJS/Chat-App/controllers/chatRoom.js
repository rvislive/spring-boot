...
export const initiate = async (req, res) => {
  try {
    ...
    // check if userId is already loggedin and trying to chat.
    if(userIds.includes(chatInitiator)) {
      return res.status(200).json({ success: false, message: 'put the different id' });
    }
